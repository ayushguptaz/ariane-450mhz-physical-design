...
# Minimal SDC (clock only, no I/O delays, no latency) — from Run 5
...
# AGGRESSIVE SYNTHESIS + MINIMAL CONSTRAINTS (Run 5 + Run 6)
# Trade area for speed — we have 64% unused area
export ABC_AREA = 0                    # Disable area optimization (timing-only)
export MAX_FANOUT_CONSTRAINT = 12      # Force buffering on high-fanout nets
export SYNTH_HIERARCHICAL = 1
export PLACE_DENSITY_LB_ADDON = 0.05   # Allow denser placement for buffers
